...
RESULTS_DIR = os.path.join(parent_dir, 'results')       # .../space_invaders/results
...
CONFIG_PATH = os.path.join(parent_dir, 'config', 'config_si_wrapper.txt')
...
def run():
    ...
    try:
        winner = p.run(pe.evaluate, n=100) # Imposta qui il numero di generazioni (es. 50 o 100)
