...
try:
    # Assuming the wrapper class name is consistent
...
def run_simulation(genome, config, seed, render=False):
    ...
    # 2. Network Setup - CRITICAL: Using RecurrentNetwork
    ...
    try:
        while not done:
            ...
            # Check for native reward in info dict
            ...
            if render and steps % 60 == 0:
                ...
                # Assuming index 5 is 'target_exists' and 4 is 'distance'
