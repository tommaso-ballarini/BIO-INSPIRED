def get_action(observation):
    ...
    # Enhanced avoidance logic with finer sensitivity and additional conditions
    if nearest_threat_dist_y < 3 and abs(nearest_threat_dx) * player_x > 0 and threat_type == -1.0:
