def get_action(observation):
    ...
    if abs(target_delta_x) > 0.1:
        ...
        if threat_type == -1:  # Tree
            action = 2 if nearest_threat_dx > 0 else 1  # slightly left to avoid trees more aggressively
            ...
            if target_delta_x >= 0 and nearest_threat_dist_y < 3:
                ...
                action = (1 if nearest_threat_dx > 0 else 2)  # steer away from flag pole threat more aggressively
