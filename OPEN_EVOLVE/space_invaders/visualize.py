...
try:
    ...
    print("❌ Errore: Impossibile importare 'wrapper.si_wrapper'.")
    print(f"Assicurati che questo script sia nella cartella 'space_invaders' e che 'wrapper' esista in: {BASE_DIR}")
    sys.exit(1)
...
def visualize():
    ...
    # Usiamo un seed fisso per vedere una partita standard, o random per variare
