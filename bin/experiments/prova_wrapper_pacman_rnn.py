...
ENV_ID = "Pacman"
CONFIG_FILE_NAME = "neat_rnn_wr_pacman_config.txt"
NUM_GENERATIONS = 50
MAX_STEPS = 3000
...
def calculate_fitness(env, net, max_steps=MAX_STEPS):
    ...
    NOTA: La rete è ricorrente (RNN), quindi mantiene stato interno.
    """
    ...
    # Reset dello stato interno della RNN
    net.reset()
    
    while not done and steps < max_steps:
        # Attivazione rete NEAT (RNN mantiene stato tra step)
...
def eval_single_genome(genome, config):
    ...
    try:
        ...
        # Creazione rete NEAT (RNN ricorrente)
...
def run_evolution():
    ...
    """
    print("=" * 80)
    print("🧬 NEAT EVOLUTION - PACMAN (RNN + FITNESS = SCORE)")
    print("=" * 80)
