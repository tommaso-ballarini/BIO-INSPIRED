# experiments/run_mspacman_neat_ocatari.py
import sys
import os
import neat
import numpy as np
...
# --- PARAMETRI ---
ENV_ID = "MsPacman-v4"
CONFIG_FILE = "neat_mspacman_ocatari_config.txt"
NUM_GENERATIONS = 100
MAX_STEPS = 3000
NUM_WORKERS = max(1, multiprocessing.cpu_count() - 1)

OUTPUT_DIR = project_root / "evolution_results" / "mspacman_ocatari"
...
def eval_single_genome(genome, config):
    ...
    try:
        ...
        ocatari_env = OCAtari(base_env, mode="ram", obs_mode="obj", render_mode=None)
        ...
        try:
            ...
            # Se fallisce, prova a prendere solo l'osservazione
            observation = env.reset()
            info = {} # Inizializza info come fallback
        done = False
        total_reward = 0.0
        steps = 0
...
if __name__ == "__main__":
    ...
    print("=" * 80)
    print("🧬 EVOLUZIONE NEAT - MS. PAC-MAN (OCAtari REM)")
    print("=" * 80)
